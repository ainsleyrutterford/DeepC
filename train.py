...
parser.add_argument('--vals', type=int, default=10, help='The number of validation samples to carry out')
parser.add_argument('--tests', type=int, default=66, help='The number of tests to carry out')
