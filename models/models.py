...
def unet3D(pretrained_weights=None, input_size=(256, 256, 9, 1)):
    inputs = Input(input_size)
    ...
    drop4 = Dropout(0.5)(conv4)
    pool4 = MaxPooling3D(pool_size=(2, 2))(drop4)
    ...
    up6 = UpSampling3D(size=(2, 2))(drop5)
    up6 = Conv3D(512, 2, activation="relu", padding="same", kernel_initializer="he_normal")(up6)
    merge6 = concatenate([drop4, up6], axis=3)
    ...
    up7 = UpSampling3D(size=(2, 2))(conv6)
    up7 = Conv3D(256, 2, activation="relu", padding="same", kernel_initializer="he_normal")(up7)
    merge7 = concatenate([conv3, up7], axis=3)
    ...
    up8 = UpSampling3D(size=(2, 2))(conv7)
    up8 = Conv3D(128, 2, activation="relu", padding="same", kernel_initializer="he_normal")(up8)
    merge8 = concatenate([conv2, up8], axis=3)
    ...
    up9 = UpSampling3D(size=(2, 2))(conv8)
    up9 = Conv3D(64, 2, activation="relu", padding="same", kernel_initializer="he_normal")(up9)
    merge9 = concatenate([conv1, up9], axis=3)
...
def segnet2D(pretrained_weights=None, num_classes=2, input_size=(256, 256, 1)):
    inputs = Input(input_size)
    ...
    conv11 = Conv2D(2, 1, activation="relu")(conv10)
