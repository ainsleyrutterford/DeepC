...
def unet3D(classes=2, input_size=(9, 256, 256, 1)):
    ...
    # conv1 = Conv3D(12, 3, activation="relu", padding="same", kernel_initializer="he_normal")(inputs)
    # conv1 = Conv3D(12, 3, activation="relu", padding="same", kernel_initializer="he_normal")(conv1)

    # conv1 = Reshape((256, 256, 108))(conv1)
    ...
    conv1 = Reshape((256, 256, 144))(conv1)
    ...
    conv2 = Reshape((128, 128, 288))(conv2)
    ...
    drop4 = Reshape((32, 32, 1152))(drop4)
    pool4 = Reshape((16, 16, 1152))(pool4)
